...
public class Rv_board {
    ...
    public Rv_board(int rv_board_index, String rv_board_post_date, String member_id, String rv_board_title, String rv_board_content, String rv_board_location, String rv_board_picture, String member_profile, int rv_board_comments, int rv_board_recommend, int rv_board_heart, int rv_board_count) {
